...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" 
        DefaultMode="Insert" CssClass="detailsview" HeaderText="New Recipe" HeaderStyle-CssClass="header" 
        FieldHeaderStyle-CssClass="fieldheader" itemstyle-cssclass="item" CommandRowStyle-CssClass="command">
        <Fields>
